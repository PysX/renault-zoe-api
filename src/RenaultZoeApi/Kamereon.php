...
class Kamereon
{
    ...
    private static function getVehicules($strAccountId,$strAccessToken,$arrGiyaTokens) {
        ...
        self::getInfo($strAccountId,'***REMOVED***','battery-status',$strAccessToken,$arrGiyaTokens,2);
        
        //self::getInfo($strAccountId,'***REMOVED***','location',$strAccessToken,$arrGiyaTokens);
        
        // not implemented : self::getInfo($strAccountId,'***REMOVED***','notification-settings',$strAccessToken,$arrGiyaTokens);
        
        //self::getInf2($strAccountId,'***REMOVED***','charge-history?type=day&start=20200101&end=20200201',$strAccessToken,$arrGiyaTokens);
    }
